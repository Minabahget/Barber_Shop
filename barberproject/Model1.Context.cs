...
namespace barberproject
{
    ...
    public partial class barberEntities1 : DbContext
    {
        public barberEntities1()
            : base("name=barberEntities1")
        {
        }
        ...
        public virtual DbSet<workers_salary> workers_salary { get; set; }
